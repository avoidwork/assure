...
then:function(a,b){return this.promise.then(a,b)}};g.prototype.constructor=g;var m=function(){return"undefined"!==typeof setImmediate?setImmediate:"undefined"!==typeof process?process.nextTick:function(a){setTimeout(a,0)}}(),h={invalidArguments:"Invalid arguments",promiseResolved:"The promise has been resolved: {{outcome}}"},b={factory:function(){return new p},freeze:"function"===typeof Object.freeze,methods:{reject:function(a){var e=this;m(function(){b.resolve.call(e,b.state.broken,a)});return this},
resolve:function(a){var e=this;m(function(){b.resolve.call(e,b.state.resolved,a)});return this},resolved:function(){return this.state===b.state.broken||this.state===b.state.resolved},then:function(a,e){var d=this,k=b.factory(),l;l=function(f){var l=f?a:e;f=f?!1:!0;var c;try{c=l.call(void 0,d.outcome),f=!1}catch(g){c=g,f=!0,void 0!==c&&!(c instanceof Error)&&("object"===typeof c&&(c=JSON.stringify(c)),c=Error(c))}finally{if(c instanceof p)d.state=b.state.pending,d.outcome=null,c.parentNode=d,c.then(function(a){d.childNodes.forEach(function(b){b.resolve(a)})},
