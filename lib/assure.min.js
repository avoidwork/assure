...
function(a){if("function"!==typeof a)throw Error(k.invalidArguments);if(this.promise.resolved())throw Error(k.promiseResolved.replace("{{outcome}}",this.promise.outcome));this.onAlways.push(a);return this};f.prototype.done=function(a){if("function"!==typeof a)throw Error(k.invalidArguments);if(this.promise.resolved())throw Error(k.promiseResolved.replace("{{outcome}}",this.promise.outcome));this.onDone.push(a);return this};f.prototype.fail=function(a){if("function"!==typeof a)throw Error(k.invalidArguments);
if(this.promise.resolved())throw Error(k.promiseResolved.replace("{{outcome}}",this.promise.outcome));this.onFail.push(a);return this};f.prototype.isRejected=function(){return this.promise.state===e.state.FAILURE};f.prototype.isResolved=function(){return this.promise.state===e.state.SUCCESS};f.prototype.reject=function(a){this.promise.reject.call(this.promise,a);return this};f.prototype.resolve=function(a){this.promise.resolve.call(this.promise,a);return this};f.prototype.state=function(){return this.promise.state};
